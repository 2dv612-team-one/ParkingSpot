...
public class UserRepositoryTest {
    ...
    private void saveUser() {
        ...
        Role userRole = roleRepo.findByName("ROLE_USER").orElseThrow(() -> new ApplicationException("No admin role exists"));
        Role adminRole = roleRepo.findByName("ROLE_ADMIN").orElseThrow(() -> new ApplicationException("No user role exists"));
